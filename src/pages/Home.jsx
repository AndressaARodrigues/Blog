        ...
        <App>
          <div className="bg-gray-100 min-h-screen w-screen">
            <div className="flex justify-between px-5 py-2 border-b bg-white">
              <span className="font-sans text-lg text-sky-500 lowercase">Página Inicial</span>
              <div>
            ...
            <div className="container mx-auto p-10">
              <form onSubmit={handleFormSubmit}>
                <p className="text-sm text-gray-600 pl-2">Comece agora mesmo...</p>
                <div>
                  <textarea
                ...
                <div className="flex justify-between">
                  ...
                  <button className="bg-sky-500 p-2 rounded text-white hover:bg-sky-600">Enviar</button>
                </div>
              </form>
              <div className="pt-5">
